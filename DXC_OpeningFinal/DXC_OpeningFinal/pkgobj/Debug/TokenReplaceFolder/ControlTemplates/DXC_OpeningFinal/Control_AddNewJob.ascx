...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Control_AddNewJob.ascx.cs" Inherits="DXC_OpeningFinal.ControlTemplates.DXC_OpeningFinal.AddNewJob" %>
            ...
            <div id="divContainer">
                <table style="width: 465px;">
                   ...
                   <%-- <tr>
                        ...
                        <td class="col2">
                            <asp:TextBox ID="txtStatus" runat="server" Width="216px"></asp:TextBox>
                        </td>
                        <td class="col3">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                ControlToValidate="txtHRContact"><img src="../../../_layouts/15/img/error.png" /></asp:RequiredFieldValidator>
                        </td>
                    </tr>--%>
                    <tr>
